...
public class ParaUI extends UI {
	...
	private boolean tresEnRaya=true;
...
//				de la botonera
				...
				RespuestaColocacion comprobarTresEnRaya = control.comprobarTresEnRaya();
				if (!comprobarTresEnRaya.isRespuesta() && tresEnRaya) {
					...
					lblMensaje.setText(comprobarTresEnRaya.getMensaje());
					if(tresEnRaya) {
						boton.setText(respuestaColocacion.getTipo().getNombre());
						tresEnRaya=false;
					}
